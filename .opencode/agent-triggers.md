...
**Use**: `@agent-manager` from `autopm/.opencode/agents/core/agent-manager.md`

### When Reviewing Code
**Trigger**: Checking for bugs, reviewing changes, or analyzing code
**Use**: `@code-analyzer` from `autopm/.opencode/agents/core/code-analyzer.md`

### When Running Tests
**Trigger**: Executing tests, analyzing test results
**Use**: `@test-runner` from `autopm/.opencode/agents/core/test-runner.md`

### When Analyzing Logs
**Trigger**: Reading log files, analyzing verbose output
**Use**: `@file-analyzer` from `autopm/.opencode/agents/core/file-analyzer.md`

### When Managing GitHub
**Trigger**: Creating releases, managing workflows
**Use**: `@github-operations-specialist` from `autopm/.opencode/agents/devops/github-operations-specialist.md`

### When Working with Docker
**Trigger**: Container configuration, Dockerfile optimization
**Use**: `@docker-containerization-expert` from `autopm/.opencode/agents/devops/docker-containerization-expert.md`

## Task-to-Agent Mapping

| Task Pattern | Agent to Use | Location |
|--------------|-------------|----------|
| "create agent" | agent-manager | autopm/.opencode/agents/core/agent-manager.md |
| "review changes" | code-analyzer | autopm/.opencode/agents/core/code-analyzer.md |
| "run tests" | test-runner | autopm/.opencode/agents/core/test-runner.md |
| "analyze log" | file-analyzer | autopm/.opencode/agents/core/file-analyzer.md |
| "prepare release" | github-operations-specialist | autopm/.opencode/agents/devops/github-operations-specialist.md |
| "optimize docker" | docker-containerization-expert | autopm/.opencode/agents/devops/docker-containerization-expert.md |
| "test installation" | test-runner | autopm/.opencode/agents/core/test-runner.md |
| "validate registry" | agent-manager | autopm/.opencode/agents/core/agent-manager.md |
...
1. Always prefer framework agents from `autopm/.opencode/agents/`
...
1. Being referenced in `.opencode/base.md`
