...
.opencode/epics/authentication/001.md
.opencode/epics/authentication/002.md
.opencode/epics/authentication/003.md
...
.opencode/epics/authentication/46.md  # Used to be 001.md
.opencode/epics/authentication/47.md  # Used to be 002.md
.opencode/epics/authentication/48.md  # Used to be 003.md
```
...
#   Generates mapping: .opencode/epics/authentication/.task-mapping.txt
...
# Verify
ls -la .opencode/epics/test-feature/
# Should show: epic.md, [github-numbers].md

# Check epic content
cat .opencode/epics/test-feature/epic.md
# Should reference: #XX, #YY, #ZZ (not 001, 002, 003)

# Check mapping file
cat .opencode/epics/test-feature/.task-mapping.txt
...
```markdown
# .opencode/epics/test-feature/001.md
...
```markdown
# .opencode/epics/test-feature/46.md
...
⚠️  File not found: .opencode/epics/auth/002.md (skipping)
...
- Example: "Task file: `.opencode/epics/auth/46.md`" (not 001.md)
...
2. ✅ `.opencode/docs/ISSUE-5-GITHUB-ISSUE-NUMBER-MAPPING.md` - This file
