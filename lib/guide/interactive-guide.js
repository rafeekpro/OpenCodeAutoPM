/**
 * Interactive Guide for OpenCodeAutoPM
...
class InteractiveGuide {
  ...
  /**
   * Check if OpenCodeAutoPM is already installed
   */
  isInstalled() {
    return fs.existsSync('.opencode') && fs.existsSync('.opencode/config.json');
  }
  ...
  async start() {
    ...
    console.log(this.createFrame(
      '🎯 OpenCodeAutoPM - AI-Powered Project Management System\n\n' +
      'Welcome! This interactive guide will help you get started with\n' +
      'OpenCodeAutoPM and show you all available options.\n\n' +
      'OpenCodeAutoPM transforms PRDs into epics, epics into issues,\n' +
      'and issues into production code with full traceability.',
      'Welcome to OpenCodeAutoPM'
    ));

    const mainOptions = [
      '📦 Install OpenCodeAutoPM in this project',
    ...
    while (!this.shouldExit) {
      ...
      switch (choice) {
        ...
        case 6:
          console.log('\n👋 Thank you for using OpenCodeAutoPM!');
          this.rl.close();
          return;
      }
    }
  ...
  async installationFlow() {
    ...
    if (this.isInstalled()) {
      console.log(this.createFrame(
        '✅ OpenCodeAutoPM is already installed in this project!\n\n' +
        'Found existing .opencode directory with configuration.\n' +
    ...
    console.log(this.createStepFrame(
      1,
      'Check System Requirements',
      'Let\'s verify your system has everything needed for OpenCodeAutoPM:'
    ));
    ...
    console.log(this.createStepFrame(
      ...
      'OpenCodeAutoPM offers different presets based on your project needs:\n\n' +
    ...
    console.log(this.createStepFrame(
      3,
      'Run Installation',
      `Installing OpenCodeAutoPM with "${selectedPreset}" preset...\n\n` +
      'This will:\n' +
      '• Create .opencode directory with agents and commands\n' +
      '• Set up configuration files\n' +
      '• Install Git hooks (if applicable)\n' +
      '• Configure team management',
      [`open-autopm install ${choiceNumber}`]
    ));
    ...
    try {
      ...
      console.log('\n' + this.createFrame(
        '🎯 Installation Complete - How to Use OpenCodeAutoPM\n\n' +
        'OpenCodeAutoPM is now installed! To start using it:\n\n' +
        '1. 📂 Open OpenCode Code in this directory\n' +
        ...
        '• 🤖 Learn about agent teams\n' +
        '• 📋 Start your first PM workflow\n\n' +
        '💡 All PM commands (/pm:xxx) work only in OpenCode Code!',
        'Ready to Use'
      ));
      ...
      switch (nextChoice) {
        ...
        case 4:
          console.log('\n👋 Thank you for using OpenCodeAutoPM!');
          console.log('🎯 Run "open-autopm guide" anytime to access this guide again.');
  ...
  async configurationFlow() {
    ...
    if (!this.isInstalled()) {
      console.log(this.createFrame(
        '⚠️  OpenCodeAutoPM is not installed in this project!\n\n' +
        'Please install OpenCodeAutoPM first by selecting the installation option\n' +
        'from the main menu.',
        'Not Installed'
      ));
      await this.waitForConfirmation();
    ...
    console.log(this.createStepFrame(
      ...
      'OpenCodeAutoPM can integrate with different project management systems:\n\n' +
    ...
    switch (providerChoice) {
      case 0:
        console.log(this.createStepFrame(
          ...
          'After setting the token, OpenCodeAutoPM will automatically\n' +
      ...
      case 2:
        console.log(this.createStepFrame(
          ...
          'OpenCodeAutoPM is configured for local-only operation.\n\n' +
          'All PRDs, epics, and issues will be stored in:\n' +
          '• .opencode/work/ directory\n\n' +
  ...
  async agentTeamsFlow() {
    ...
    console.log(this.createStepFrame(
      ...
      'OpenCodeAutoPM uses specialized AI agent teams for different contexts:\n\n' +
    ...
    console.log(this.createStepFrame(
      ...
      [
        'open-autopm team load frontend',
        'open-autopm team load devops',
        'open-autopm team load python_backend',
        'open-autopm team current'
      ]
    ));
  ...
  async firstProjectFlow() {
    ...
    if (!this.isInstalled()) {
      console.log(this.createFrame(
        '⚠️  OpenCodeAutoPM is not installed in this project!\n\n' +
        'Please install OpenCodeAutoPM first.',
        'Not Installed'
      ));
      await this.waitForConfirmation();
      return;
    ...
    console.log(this.createStepFrame(
      ...
      '• AI-powered: Brainstorming with OpenCode Code\n\n' +
    ...
    console.log(this.createStepFrame(
      ...
      '🚀 Open OpenCode Code and use these commands:',
      [
        '/pm:next',
  ...
  async troubleshootingFlow() {
    ...
    console.log(this.createFrame(
      '🔧 OpenCodeAutoPM Troubleshooting\n\n' +
    ...
    switch (issueChoice) {
      ...
      case 1:
        console.log(this.createStepFrame(
          ...
          'If open-autopm commands are not found:\n\n' +
      ...
      case 6:
        console.log(this.createStepFrame(
          ...
          'Checking OpenCodeAutoPM installation and configuration...'
        ));
        ...
        if (fs.existsSync('.opencode/teams.json')) {
        ...
        if (fs.existsSync('.opencode/active_team.txt')) {
          const activeTeam = fs.readFileSync('.opencode/active_team.txt', 'utf8').trim();
  ...
  async documentationFlow() {
    ...
    const urls = [
      'https://rafeekpro.github.io/OpenCodeAutoPM/',
      'https://rafeekpro.github.io/OpenCodeAutoPM/guide/getting-started',
      'https://rafeekpro.github.io/OpenCodeAutoPM/commands/overview',
      'https://rafeekpro.github.io/OpenCodeAutoPM/agents/registry',
      'https://rafeekpro.github.io/OpenCodeAutoPM/development/docker-first',
      'https://rafeekpro.github.io/OpenCodeAutoPM/reference/configuration',
      'https://github.com/rafeekpro/OpenCodeAutoPM/wiki',
      'https://github.com/rafeekpro/OpenCodeAutoPM/tree/main/examples'
    ];
