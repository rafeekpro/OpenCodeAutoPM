 ...
 *
 * Provides interactive configuration management for OpenCodeAutoPM.
...
async function configInit() {
  ...
  try {
    ...
    console.log('\n╔══════════════════════════════════════╗');
    console.log('║  OpenCodeAutoPM Configuration Wizard   ║');
    console.log('╚══════════════════════════════════════╝\n');
    ...
    const questions = [
      {
        ...
        message: 'AI Backend:',
        choices: [
          { name: 'OpenCode API (recommended)', value: 'claude' },
      ...
      },
      {
        ...
        when: (answers) => answers.backend === 'claude',
        choices: [
          { name: 'OpenCode 3.5 Sonnet (recommended)', value: 'claude-3-5-sonnet-20241022' },
          { name: 'OpenCode 3 Opus', value: 'claude-3-opus-20240229' },
          { name: 'OpenCode 3 Haiku', value: 'claude-3-haiku-20240307' }
        ],
...
module.exports = {
  ...
  describe: 'Manage OpenCodeAutoPM configuration',
  builder,
  handlers: {
    init: configInit,
    set: configSet,
