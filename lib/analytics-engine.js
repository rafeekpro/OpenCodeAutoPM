 ...
 * const engine = new AnalyticsEngine({ basePath: '.opencode' });
 *
...
class AnalyticsEngine {
   ...
   * @param {string} options.basePath - Base path for file operations (default: '.opencode')
   */
  constructor(options = {}) {
    this.basePath = options.basePath || '.opencode';
