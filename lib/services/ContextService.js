 ...
 *
 * Pure service layer for context operations following OpenCodeAutoPM patterns.
...
class ContextService {
  ...
  constructor(options = {}) {
    this.templatesPath = options.templatesPath ||
      path.join(process.cwd(), '.opencode/templates/context-templates');
    this.contextPath = options.contextPath ||
      path.join(process.cwd(), '.opencode/context');
    this.epicsPath = options.epicsPath ||
      path.join(process.cwd(), '.opencode/epics');
    this.issuesPath = options.issuesPath ||
      path.join(process.cwd(), '.opencode/issues');
  }
