...
- **`.opencode/rules/context-compaction.md`** - Automatic compaction rules and triggers
- **`.opencode/guides/memory-patterns.md`** - File-based memory patterns for session continuity
...
3. **Memory Patterns**: Use `.opencode/active-work.json` for cross-session state
