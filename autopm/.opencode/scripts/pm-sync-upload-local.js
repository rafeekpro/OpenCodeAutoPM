 ...
 *   const syncMap = await loadSyncMap('.opencode/sync-map.json');
 *
 *   // Sync a PRD
 *   await syncPRDToGitHub('.opencode/prds/prd-001.md', repo, octokit, syncMap);
 *
 *   // Sync an Epic
 *   await syncEpicToGitHub('.opencode/epics/epic-001/epic.md', repo, octokit, syncMap);
 *
 *   // Sync a Task
 *   await syncTaskToGitHub('.opencode/epics/epic-001/task-001.md', repo, octokit, syncMap);
 *
 *   // Save sync map
 *   await saveSyncMap('.opencode/sync-map.json', syncMap);
 */
