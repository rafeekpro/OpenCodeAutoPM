 ...
 * PRDs are stored in .opencode/prds/ directory.
 *
 * Usage:
...
/**
 * Creates a new PRD in the local .opencode/prds/ directory
 *
...
async function createLocalPRD(name, options = {}) {
  ...
  const filepath = path.join(process.cwd(), '.opencode', 'prds', filename);
