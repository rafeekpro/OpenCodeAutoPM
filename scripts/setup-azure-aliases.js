...
# Generated by OpenCodeAutoPM

# Quick access to daily workflow
alias az-daily='./autopm/.opencode/scripts/azure/daily.sh'
alias azd='az-daily'

# Task management
alias az-next='./autopm/.opencode/scripts/azure/next-task.sh'
alias azn='az-next'
alias az-tasks='./autopm/.opencode/scripts/azure/active-work.sh'
alias azt='az-tasks'
alias az-blocked='./autopm/.opencode/scripts/azure/blocked.sh'
alias azb='az-blocked'

# User Story management
alias az-us='./autopm/.opencode/scripts/azure/us-list.sh'
alias azu='az-us'
alias az-us-status='./autopm/.opencode/scripts/azure/us-status.sh'
alias azus='az-us-status'

# Feature management
alias az-features='./autopm/.opencode/scripts/azure/feature-list.sh'
alias azf='az-features'
alias az-feature-show='./autopm/.opencode/scripts/azure/feature-show.sh'
alias azfs='az-feature-show'

# Sprint and reporting
alias az-sprint='./autopm/.opencode/scripts/azure/sprint-report.sh current'
alias azs='az-sprint'
alias az-dash='./autopm/.opencode/scripts/azure/dashboard.sh'
alias azdb='az-dash'

# Synchronization
alias az-sync='./autopm/.opencode/scripts/azure/sync.sh --quick'
alias az-sync-full='./autopm/.opencode/scripts/azure/sync.sh --full'
alias azsy='az-sync'

# Search
alias az-search='./autopm/.opencode/scripts/azure/search.sh'
alias azsr='az-search'

# Validation
alias az-validate='./autopm/.opencode/scripts/azure/validate.sh'
...
az-work-on() {
    ...
    ./autopm/.opencode/scripts/azure/task-start.sh "$1"
}
...
az-complete() {
    ...
    ./autopm/.opencode/scripts/azure/task-close.sh "$1"
}
...
az-find() {
    ...
    ./autopm/.opencode/scripts/azure/search.sh "$@"
}
...
az-show() {
    ...
    if [[ "$1" =~ ^F ]]; then
        ./autopm/.opencode/scripts/azure/feature-show.sh "$1"
    elif [[ "$1" =~ ^US ]]; then
        ./autopm/.opencode/scripts/azure/us-status.sh "$1"
    else
        ./autopm/.opencode/scripts/azure/task-show.sh "$1"
    fi
}
